...
## Content outline
  ...
  - Background on machine learning
      ...
      - Performance metrics
  - Data preprocessing 
      - Tidymodels related packages: ([rsample](https://github.com/tidymodels/rsample), [recipes](https://recipes.tidymodels.org/reference/index.html), [textrecipes](https://github.com/tidymodels/textrecipes))
      - Missing data
      - Train/test splits
  - Algorithm walkthroughs 
      - Tidymodels related packages: ([workflows](https://github.com/tidymodels/workflows), [parsnip](https://github.com/tidymodels/parsnip), [tune](https://github.com/tidymodels/tune), [dials](https://github.com/tidymodels/dials), [yardstick](https://github.com/tidymodels/yardstick))
      - Lasso
      - Decision trees
      - Random forests
