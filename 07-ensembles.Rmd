...
* `SuperLearner` takes a weighted average of the learners using the coefficients (importance of each individual learner in the overall ensemble). Coefficient 0 means that learner is not used at all.
* `SL.mean_All` (the mean of $Y$) is a benchmark algorithm. 
