...
2. Introduce the Tidymodels framework for a consistent way to fit machine learning models. 
3. Apply the Tidymodels framework to explore multiple machine learning algorithms.
