---
title: "Tidymodels Book Notes" 
---
## General points 

Rewrite all of this. 

For references make sure to cite Tidymodels book by Kuhn and Silge 

Other resources Athey and Imbens Annual Review Piece 

Introduction to Statistical Learning 2nd Edition James et al 

## Workshop structure 

1. Conceptualizing Machine Learning 
  - What is it?
  - What kind of problems does it work well on?
  - What kind of problems does it work less well on?
  - Regression and Classification
2. Introduce Tidymodels 
  - Data spend 
  - Workflow process 
  ...
  - Important concepts and structure 
3. Tidymodels with supervised learning 
  - Linear Regression
  - Classification 
  - Random Forests 
  - Ensembles
...
In some cases, preprocessing techniques require tuning:
    ...
    Imputation methods estimate missing predictor values using the complete values of one or more predictors. One effective imputation tool uses K

    -nearest neighbors of the complete columns to predict the missing value. The number of neighbors modulates the amount of averaging and can be tuned.
