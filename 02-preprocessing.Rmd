...
Splitting data into training and test subsets is a fundamental step in machine learning. Usually, the larger portion of the original dataset is partitioned to the training set, where the algorithms learn the relationships between the $x$ feature predictors and the $y$ outcome variable. These models are then given new data (the test set) to see how well they perform on data they have not yet seen. 
